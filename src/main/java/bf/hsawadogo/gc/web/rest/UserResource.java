...
import bf.hsawadogo.gc.config.Constants;
import bf.hsawadogo.gc.domain.User;
import bf.hsawadogo.gc.repository.UserRepository;
import bf.hsawadogo.gc.security.AuthoritiesConstants;
import bf.hsawadogo.gc.service.MailService;
import bf.hsawadogo.gc.service.UserService;
import bf.hsawadogo.gc.service.dto.AdminUserDTO;
import bf.hsawadogo.gc.web.rest.errors.BadRequestAlertException;
import bf.hsawadogo.gc.web.rest.errors.EmailAlreadyUsedException;
import bf.hsawadogo.gc.web.rest.errors.LoginAlreadyUsedException;
 ...
 * <p>
 * This class accesses the {@link bf.hsawadogo.gc.domain.User} entity, and needs to fetch its collection of authorities.
 * <p>
